...
class Database:
    ...
    def createTable(self):
        ...
        self.cursor.execute("CREATE TABLE IF NOT EXISTS video (no INTEGER PRIMARY KEY AUTOINCREMENT, url TEXT, playlist INTEGER, FOREIGN KEY(playlist) REFERENCES playlist (no) ON DELETE CASCADE) ")
